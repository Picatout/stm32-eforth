...
*************************************/
  ...
  .equ FTRACE_OFS, TIMER_OFS+4  // compile to RAM 
  .equ IMG_SIGN_OFS, FTRACE_OFS+4  // image signature  
...
COMPI_NEST:
	add r6,r3,#RAM_CTOP_OFS 
	ldr r6,[r6]
	mov r7,#0x4700+(8<<3)
	strh r7,[r6],#2
	mov r7,#0xbf00 // NOP.N   
	strh r7,[r6],#2 
	add r7,r3,#RAM_CTOP_OFS 
	str r6,[r7]
	_NEXT  
