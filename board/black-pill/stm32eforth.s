...
/* eForth specific constants */
	...
	.equ UPP ,	0x20000200	/*start of user area (UP0) */
	.equ DEND , SPP-128  /*usable RAM end */
	.equ RAMOFFSET ,	UPP 	// remap
	.equ FLASHOFFSET ,	0x08000200	// remap
...
/* enable peripheral clock for GPIOA, GPIOC and USART1 */
  mov	r1, #(1)|(1<<2)		/* GPIOAEN|GPIOCEN */
  str	r1, [r0, #RCC_AHB1ENR]
  mov	r1, #(1<<4)  /* USART1 enable */
